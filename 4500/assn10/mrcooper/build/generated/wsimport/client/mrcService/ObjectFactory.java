 ...
 * generated in the mrcService package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetReviewsResponse_QNAME = new QName("http://movies/", "getReviewsResponse");
    private final static QName _GetReviews_QNAME = new QName("http://movies/", "getReviews");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mrcService
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://movies/", name = "getReviewsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://movies/", name = "getReviews")

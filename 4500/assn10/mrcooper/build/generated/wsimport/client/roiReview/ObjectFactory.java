 ...
 * generated in the roiReview package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetReviews_QNAME = new QName("http://ksamim/", "getReviews");
    private final static QName _GetReviewsResponse_QNAME = new QName("http://ksamim/", "getReviewsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: roiReview
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ksamim/", name = "getReviews")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ksamim/", name = "getReviewsResponse")

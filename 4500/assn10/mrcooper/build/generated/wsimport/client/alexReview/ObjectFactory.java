 ...
 * generated in the alexReview package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetReviews_QNAME = new QName("http://acronon/", "getReviews");
    private final static QName _GetReviewsResponse_QNAME = new QName("http://acronon/", "getReviewsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: alexReview
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://acronon/", name = "getReviews")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://acronon/", name = "getReviewsResponse")

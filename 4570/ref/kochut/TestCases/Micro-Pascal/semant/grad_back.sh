...
echo ------------------
echo parsing ERROR No13: Line 68: Incompatible type in array element assignment
$PGM ${DIR}/semant/err13.p
echo ------------------
echo parsing ERROR No14: Line 73: Type mismatch in parameter passing
